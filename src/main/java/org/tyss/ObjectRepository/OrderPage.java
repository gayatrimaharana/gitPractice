...
public class OrderPage {
	...
	@FindBy(xpath = "//android.widget.ImageView[@content-desc='Retry']") 
	private WebElement TryAgain;
	@FindBy(xpath = "//android.widget.Button[@text='OK']") 
	private WebElement OkBtn;
	@FindBy(xpath = "//android.widget.FrameLayout[@content-desc='bigbasket']") 
	private WebElement bigBasketIcon;
	@FindBy(xpath = "//android.widget.TextView[@text='Explore Bangalore Store']") 
	private WebElement BangaloreStore;
	@FindBy(xpath = "(//android.widget.ImageView[@content-desc=\"Product Image\"])[5]") 
	private WebElement ShopByCategory;
	@FindBy(xpath = "(//android.widget.ImageView[@content-desc=\"Product Image\"])[2]")
	private WebElement ShopByCategory2;
	@FindBy(xpath = "(//android.widget.ImageView[@content-desc=\"Product Image\"])[1]") 
	private WebElement ShopByCategory3;
	@FindBy(xpath = "//android.widget.TextView[@bounds='[763,976][1052,1072]']")
