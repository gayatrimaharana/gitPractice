...
public class PaymentPage extends org.tyss.genericUtility.MobileUtility{
	...
	@FindBy(xpath = "//android.widget.Button[@text='Login / Signup']")
	...
	@FindBy(xpath = "//android.widget.TextView[@text='Cash on Delivery']") 
	private WebElement CashOnDeliveryBtn;
	@FindBy(xpath = "//android.widget.TextView[@text='Place Order']") 
	private WebElement PlaceOrderBtn;
	@FindBy(xpath = "//android.widget.ImageView[@resource-id='com.bigbasket.mobileapp:id/imgBtnClose']") 
	private WebElement CrossBtn;
	@FindBy(xpath = "//android.widget.RelativeLayout[@resource-id='com.bigbasket.mobileapp:id/closeButtonView']") 
